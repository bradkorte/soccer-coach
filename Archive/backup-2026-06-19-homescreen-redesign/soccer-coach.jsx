...
// ════════════════════════════════════════════════════════════════════════════════
function HomeScreen({ games, settings, onMatchDay, onGoSeason, onGoTeam, onGoMore, onGoAccount }) {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#0D0D0D', paddingBottom:90, paddingTop:'max(env(safe-area-inset-top),0px)' }}>
      ...
      {/* ── Top bar ── */}
      <div style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'10px 18px', background:'#000000', borderBottom:'1px solid #1A1A1A' }}>
        <button onClick={onGoMore} style={{ background:'none', border:'none', cursor:'pointer', padding:6 }}>
      ...
      <div style={{ padding:'28px 20px 32px', background:'radial-gradient(ellipse at 65% -10%, #3D2800 0%, #1A1000 40%, #0D0D0D 72%)', borderBottom:'1px solid #1A1A1A' }}>
        <div style={{ fontSize:13, color:'#A1A1A1', fontWeight:500, marginBottom:2 }}>{getGreeting()}, Coach</div>
        <div style={{ fontSize:44, fontWeight:900, color:'#FFFFFF', lineHeight:1.05, marginBottom:6 }}>{coachName}</div>
        <div style={{ fontSize:13, color:'#A1A1A1', fontStyle:'italic' }}>Let's elevate today.</div>
      </div>
      ...
      <div style={{ padding:'14px 16px 0' }}>
        <div onClick={onGoTeam} style={{ background:'#1A1A1A', borderRadius:14, padding:'14px 16px', border:'1px solid #2A2A2A', cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
          <div style={{ display:'flex', alignItems:'center', gap:12 }}>
            <div style={{ width:44, height:44, borderRadius:10, background:'#F5C04A', display:'flex', alignItems:'center', justifyContent:'center', fontSize:22, fontWeight:900, color:'#0D0D0D', flexShrink:0 }}>K</div>
            <div>
              <div style={{ fontSize:10, color:'#A1A1A1', fontWeight:700, letterSpacing:0.5, marginBottom:2 }}>Your Team</div>
              <div style={{ fontSize:17, fontWeight:800, color:'#FFFFFF' }}>{teamName}</div>
              <div style={{ fontSize:11, color:'#A1A1A1', marginTop:1 }}>{playerCount > 0 ? `${playerCount} Players` : 'Tap to manage squad'}</div>
            </div>
          </div>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#F5C04A" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M9 18l6-6-6-6"/></svg>
        </div>
      </div>
      ...
      {nextFix && (
        <div style={{ padding:'12px 16px 0' }}>
          <div style={{ background:'#1A1A1A', borderRadius:14, padding:'16px', border:'1px solid #2A2A2A' }}>
            <div style={{ fontSize:11, color:'#A1A1A1', fontWeight:700, letterSpacing:0.5, marginBottom:14 }}>Next Match</div>
            <div style={{ display:'flex', alignItems:'center', gap:10, marginBottom:14 }}>
              <div style={{ flex:1 }}>
                <div style={{ width:42, height:42, borderRadius:10, background:'#F5C04A', display:'flex', alignItems:'center', justifyContent:'center', fontSize:18, fontWeight:900, color:'#0D0D0D', marginBottom:6 }}>K</div>
                <div style={{ fontSize:13, fontWeight:700, color:'#FFFFFF', lineHeight:1.2 }}>{nextFix.home}</div>
              </div>
              <div style={{ flexShrink:0, alignSelf:'center', paddingBottom:20 }}>
                <div style={{ padding:'5px 12px', background:'#0D0D0D', borderRadius:8, border:'1px solid #2A2A2A', fontSize:11, color:'#A1A1A1', fontWeight:700 }}>vs</div>
              </div>
              <div style={{ flex:1, display:'flex', flexDirection:'column', alignItems:'flex-end' }}>
                <div style={{ width:42, height:42, borderRadius:10, background:'#2A2A2A', display:'flex', alignItems:'center', justifyContent:'center', fontSize:16, fontWeight:700, color:'#A1A1A1', marginBottom:6 }}>{(nextFix.away||'?')[0]}</div>
                <div style={{ fontSize:13, fontWeight:700, color:'#FFFFFF', textAlign:'right', lineHeight:1.2 }}>{nextFix.away}</div>
              </div>
            </div>
            <div style={{ display:'flex', alignItems:'center', gap:14, marginBottom:14, flexWrap:'wrap' }}>
              <div style={{ display:'flex', alignItems:'center', gap:5 }}>
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#A1A1A1" strokeWidth="2" strokeLinecap="round"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
              ...
              {nextFix.venue && <div style={{ display:'flex', alignItems:'center', gap:5 }}>
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#A1A1A1" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
                <span style={{ fontSize:11, color:'#A1A1A1' }}>{nextFix.venue}</span>
              </div>}
            </div>
            <button onClick={onMatchDay} style={{ width:'100%', background:'#F5C04A', color:'#0D0D0D', border:'none', borderRadius:10, padding:'12px 0', fontWeight:800, fontSize:14, cursor:'pointer' }}>View Match</button>
          </div>
        </div>
      )}
      ...
      <div style={{ padding:'12px 16px 0' }}>
        <div style={{ background:'#1A1A1A', borderRadius:14, padding:'16px', border:'1px solid #2A2A2A' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:14 }}>
            <span style={{ fontSize:14, fontWeight:700, color:'#FFFFFF' }}>Performance Overview</span>
            <button onClick={onGoSeason} style={{ background:'none', border:'none', cursor:'pointer', fontSize:12, fontWeight:700, color:'#F5C04A', padding:0 }}>See All</button>
          </div>
          <div style={{ display:'flex', gap:12, alignItems:'center' }}>
            <div style={{ flexShrink:0, position:'relative', width:110, height:110 }}>
              <svg width="110" height="110" viewBox="0 0 110 110">
                ...
                {played > 0 && <circle cx="55" cy="55" r={R} fill="none" stroke="#F5C04A" strokeWidth="8"
                  strokeDasharray={`${arcLen} ${arcGap}`} strokeDashoffset={CIRC*0.25}
                  strokeLinecap="round" transform="rotate(-90 55 55)"/>}
              </svg>
              <div style={{ position:'absolute', inset:0, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center' }}>
                <div style={{ fontSize:22, fontWeight:900, color:'#FFFFFF', lineHeight:1 }}>{winRate}<span style={{ fontSize:12 }}>%</span></div>
                <div style={{ fontSize:9, color:'#A1A1A1', fontWeight:600, textAlign:'center', marginTop:2 }}>Win Rate</div>
                {wins > 0 && <div style={{ fontSize:9, color:'#4ade80', marginTop:3, fontWeight:700 }}>▲ {wins}W {losses}L</div>}
              </div>
            </div>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:8, marginTop:8 }}>
            {[['Drawn',draws,'#f59e0b'],['Lost',losses,'#ef4444'],['Goal Diff',(gd>=0?'+':'')+gd,gd>=0?'#4ade80':'#ef4444']].map(([label,val,color])=>(
              <div key={label} style={{ background:'#0D0D0D', borderRadius:10, padding:'8px 6px', textAlign:'center' }}>
                ...
                <div style={{ fontSize:10, color:'#A1A1A1', marginTop:1 }}>{label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ padding:'12px 16px 16px' }}>
        <div style={{ background:'#1A1A1A', borderRadius:14, padding:'16px', border:'1px solid #2A2A2A' }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:14 }}>
            <span style={{ fontSize:14, fontWeight:700, color:'#FFFFFF' }}>Recent Activity</span>
            <button onClick={onGoSeason} style={{ background:'none', border:'none', cursor:'pointer', fontSize:12, fontWeight:700, color:'#F5C04A', padding:0 }}>See All</button>
          </div>
          {recentRes.length === 0 ? (
            ...
            return (
              <div key={r.id||i} style={{ display:'flex', alignItems:'center', gap:12, paddingBottom:notLast?12:0, borderBottom:notLast?'1px solid #2A2A2A':'none', marginBottom:notLast?12:0 }}>
                <div style={{ width:40, height:40, borderRadius:'50%', background:col+'22', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
                  <span style={{ fontSize:13, fontWeight:900, color:col }}>{res}</span>
                </div>
                <div style={{ flex:1, minWidth:0 }}>
                  <div style={{ fontSize:13, fontWeight:700, color:'#FFFFFF' }}>vs {r.opponent}</div>
                  <div style={{ fontSize:11, color:'#A1A1A1', marginTop:1 }}>{r.us}–{r.them} · {fmtDate(r.dateStr)}</div>
                </div>
                <div style={{ fontSize:11, fontWeight:700, color:col, flexShrink:0 }}>{res==='W'?'Win':res==='L'?'Loss':'Draw'}</div>
              </div>
            );
          })}
        </div>
...
export default function App() {
  ...
  function renderScreen() {
    if(screen==="home")         return <HomeScreen games={games} settings={settings} onMatchDay={()=>goTab("match")} onGoSeason={()=>goTab("season")} onGoTeam={()=>goTab("team")} onGoMore={()=>setScreen("more")} onGoAccount={()=>setScreen("account")} />;
