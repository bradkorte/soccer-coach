  ...
  return (
    <div style={{ minHeight:'100vh', background:'#0D0D0D', paddingBottom:80, paddingTop:'max(env(safe-area-inset-top),0px)' }}>
      ...
      <div style={{
        ...
        <svg viewBox="0 0 400 92" width="100%" style={{display:'block'}} overflow="visible">

          {/* ══ SWOOSH — clockwise large arc, wraps RIGHT side of player ══ */}
          {/* Starts near ball (lower-left), sweeps down-right-up-left = ")" shape */}
          <path d="M 22 84 A 44 44 0 1 1 20 8"
            stroke="#F5C04A" strokeWidth="3.5" fill="none" strokeLinecap="round"/>

          {/* ══ PLAYER SILHOUETTE — running right, follow-through kick (ball went left) ══ */}

          {/* Head */}
          <circle cx="68" cy="12" r="9.5" fill="#F5C04A"/>

          {/* Neck → torso (player leans forward-right) */}
          <path d="M 68 22 Q 66 34 62 48"
            stroke="#F5C04A" strokeWidth="16" strokeLinecap="round" fill="none"/>

          {/* LEFT arm — forward-right (counterbalances kicking leg) */}
          <path d="M 65 28 Q 79 22 90 18"
            stroke="#F5C04A" strokeWidth="9" strokeLinecap="round" fill="none"/>
          <path d="M 90 18 Q 100 15 107 13"
            stroke="#F5C04A" strokeWidth="7" strokeLinecap="round" fill="none"/>

          {/* RIGHT arm — swings back-left */}
          <path d="M 65 28 Q 52 36 44 44"
            stroke="#F5C04A" strokeWidth="9" strokeLinecap="round" fill="none"/>
          <path d="M 44 44 Q 38 50 34 56"
            stroke="#F5C04A" strokeWidth="7" strokeLinecap="round" fill="none"/>

          {/* RIGHT leg — support/planted, striding forward-right */}
          <path d="M 64 48 Q 76 64 78 80"
            stroke="#F5C04A" strokeWidth="13" strokeLinecap="round" fill="none"/>
          <path d="M 78 80 Q 78 87 74 90"
            stroke="#F5C04A" strokeWidth="10" strokeLinecap="round" fill="none"/>
          {/* Right foot (flat on ground) */}
          <path d="M 74 90 Q 64 93 56 91"
            stroke="#F5C04A" strokeWidth="8" strokeLinecap="round" fill="none"/>

          {/* LEFT leg — kicking leg, extended back-left (follow-through) */}
          {/* Upper thigh going back-left */}
          <path d="M 62 48 Q 46 60 32 68"
            stroke="#F5C04A" strokeWidth="13" strokeLinecap="round" fill="none"/>
          {/* Lower leg extended toward ball */}
          <path d="M 32 68 Q 22 74 14 76"
            stroke="#F5C04A" strokeWidth="11" strokeLinecap="round" fill="none"/>
          {/* Kicking foot near ball */}
          <path d="M 14 76 Q 7 78 4 80"
            stroke="#F5C04A" strokeWidth="8" strokeLinecap="round" fill="none"/>

          {/* ══ BALL ══ */}
          <circle cx="16" cy="84" r="9" stroke="#F5C04A" strokeWidth="2.5" fill="none"/>
          {/* Pentagon seam lines */}
          <path d="M 16 75 Q 20 79 16 84 Q 12 89 16 93"
            stroke="#F5C04A" strokeWidth="1.2" fill="none" opacity="0.5"/>
          <path d="M 8 79 Q 12 82 16 84 Q 20 86 24 82"
            stroke="#F5C04A" strokeWidth="1.2" fill="none" opacity="0.5"/>

          {/* ══ MOTION LINES — speed trail to the left of ball ══ */}
          <line x1="5" y1="77" x2="-10" y2="73" stroke="#F5C04A" strokeWidth="2.5" strokeLinecap="round"/>
          <line x1="5" y1="83" x2="-13" y2="83" stroke="#F5C04A" strokeWidth="2.5" strokeLinecap="round"/>
          <line x1="5" y1="89" x2="-8" y2="93" stroke="#F5C04A" strokeWidth="2.5" strokeLinecap="round"/>

          {/* ══ KHULA WORDMARK ══ */}
          <text x="122" y="64"
            fontFamily="'Outfit',sans-serif" fontSize="58" fontWeight="900"
            fill="#FFFFFF" letterSpacing="3">KHULA</text>

          {/* Gold ▲ above A — A starts at ~122+(4×40)=282, center ~302 */}
          <polygon points="302,4 312,17 292,17" fill="#F5C04A"/>

          {/* ══ TAGLINE ══ */}
          <text x="124" y="80"
            fontFamily="'Outfit',sans-serif" fontSize="11" fontWeight="600"
            fill="#F5C04A" letterSpacing="2.2">PLAY. CONNECT. ELEVATE.</text>
